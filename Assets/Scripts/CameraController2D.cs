...
public class CameraController2D : MonoBehaviour
{
    ...
    private void CalculateCameraBoundaries()
    {
        ...
        leftBoundaryLimit = 
            tilemap.transform.position.x + tilemap.cellBounds.min.x + viewportHalfSize.x;
        rightBoundaryLimit = 
            tilemap.transform.position.x + tilemap.cellBounds.max.x - viewportHalfSize.x;
        bottomBoundaryLimit =
            tilemap.transform.position.y + tilemap.cellBounds.min.y + viewportHalfSize.y;
    }
